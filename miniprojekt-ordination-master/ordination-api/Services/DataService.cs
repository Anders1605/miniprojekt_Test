...
public class DataService
{
	...
	public void SeedData()
	{
		...
		if (patients[0] == null)
		{
			patients[0] = new Patient("121256-0512", "Jane Jensen", 20.0);
			patients[1] = new Patient("070985-1153", "Finn Madsen", 130.0);
			...
			patients[5] = new Patient("123456-5555", "Lille Per", 22);
			patients[6] = new Patient("123456-6666", "Store Per", 126.7);
